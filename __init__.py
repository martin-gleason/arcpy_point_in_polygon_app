...
# temporary at 2.8 due to 2.7 env being created with symlinks
from pathlib import Path
if Path(sys.prefix).joinpath("Lib", "site-packages", "arcgisscripting", "_arcgisscripting.pyd").is_symlink():
...
Please recreate your environment using ArcGISPro 2.8
"""
    print(msg)
    raise ImportError("version mis-match") 
...
# importing nax makes arcpy.na available which is not desirable on native linux since arcpy.na is deprecated on native
# linux
...
def AttachLocator(loc_path, fc_path, input_field_names, output_field_names):
    ...
    return arcgisscripting._attachLocator(loc_path, fc_path, input_field_names, output_field_names)
...
def CreateGeocodeSDDraft(loc_path, out_sddraft, service_name, server_type='ARCGIS_SERVER',
                         ...
                         suggested_batch_size=1000, supported_operations=["GEOCODE","REVERSE_GEOCODE"],
