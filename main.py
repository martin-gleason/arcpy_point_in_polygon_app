...
res = str(gc.return_district(terry_ln, verbose = True))
...
for address in addresses:
    ...
    print(gc.geocode_to_district(address.get('address')))

add = input()
input_resopnse = gc.geocode_to_district(add)
print('the district  of the live test is: ' + str(input_resopnse))
